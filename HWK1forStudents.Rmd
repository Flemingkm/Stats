...
```{r prob4}
unclean <- table(apply(is.na(BABIES),1,sum))
dim(unclean)
unclean[2]

```

> **Prob 4 answer:** There are `r unclean[0]` rows with no missing values, `r unclean[1]` with one missing value, `r unclean[2]` with two missing values.
